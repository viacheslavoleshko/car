...
var MotDetailsPageModule = /** @class */ (function () {
    function MotDetailsPageModule() {
    }
...
var MotDetailsPage = /** @class */ (function () {
    function MotDetailsPage(carService, router, route) {
        var _this = this;
        ...
        setTimeout(function () {
            _this.carService.getMot(_this.regNumb).subscribe(function (val) {
                _this.mot = val['object'];
                console.log(_this.mot);
            });
        }, 500);
    }
    MotDetailsPage.prototype.ngOnInit = function () {
    };
    MotDetailsPage.prototype.toHome = function () {
        this.router.navigate(['/']);
    };
    MotDetailsPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-mot-details-mot-details-module-es5.js.map