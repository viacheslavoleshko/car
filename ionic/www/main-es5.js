...
var map = {
	...
	"./pages/mot-details/mot-details.module": [
	...
	"./pages/tax-details/tax-details.module": [
...
/* harmony import */ var _car_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./car.service */ "./src/app/car.service.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _car_service__WEBPACK_IMPORTED_MODULE_11__["CarService"]
            ],
...
var CarService = /** @class */ (function () {
    function CarService(http) {
        this.http = http;
        this.basepath = 'http://car.nix.ltd';
    }
    CarService.prototype.getTax = function (registration) {
        return this.http.get(this.basepath + "/tax/" + registration);
    };
    CarService.prototype.getMot = function (registration) {
...
module.exports = __webpack_require__(/*! D:\XAMPP\htdocs\WORK\car\ionic\src\main.ts */"./src/main.ts");
